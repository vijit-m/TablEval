...
class TapasTokenizer:
  ...
  def __init__(self, vocab_file):
    # self._basic_tokenizer = AutoTokenizer.from_pretrained("allenai/scibert_scivocab_uncased")
    # self._wp_tokenizer = AutoTokenizer.from_pretrained("allenai/scibert_scivocab_uncased")
