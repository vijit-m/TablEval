...
# from tapas.scripts import calc_structure_metrics
...
flags.DEFINE_bool('prune_columns', True,
...
def _create_examples(
  ...
  if batch_size is None:
    ...
    print("HIIIIIIII THEREEEEEE #############")
    print(originial_num_examples)
...
def _eval_for_set(
  ...
  if task in [
    ...
    # K=calc_metrics_utils.calc_structure_metrics(test_examples,None)
    # print(K)
  else:
    raise ValueError(f'Unknown task: {task.name}')
