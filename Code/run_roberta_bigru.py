...
def main():
    ...
    config1=RobertaConfig.from_pretrained(load_dir,output_hidden_states=True)
    roberta =RobertaModel.from_pretrained(load_dir )
    ...
    class ROBERTAGRUSentiment(nn.Module):
      def __init__(self,
          ...
          self.dense = nn.Linear(hidden_dim*2, hidden_dim*2)
        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                if (step + 1) % args.period == 0:
                    ...
                    #output_config_file = os.path.join(output_dir, CONFIG_NAME)  #model_to_save.config.to_json_file(output_config_file)
